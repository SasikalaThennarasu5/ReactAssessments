...
export default function FigmaTechnicalQuestions() {
  const navigate = useNavigate();

  const handleNextClick = () => {
    navigate("/figma-technical-questions-cont");
  };
  ...
  return (
    <div className="container py-4" style={{ fontFamily: "Urbanist, sans-serif" }}>
      <h3 className="fw-bold text-center mb-4">Figma Technical Questions</h3>
      ...
      <div className="bg-light p-4 rounded" style={{ backgroundColor: "#f1fbb3" }}>
        ...
        <div className="d-flex justify-content-between mt-4">
          <button className="btn btn-dark px-4">Previous</button>
          <button
            className="btn px-4"
