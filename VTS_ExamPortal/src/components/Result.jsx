...
const Result = () => {
  ...
  return (
    <div className="container-fluid min-vh-100 p-3" style={styles} ref={pdfRef}>
                ...
                <td style={{ backgroundColor: "#D8F275" }}>
                  {editMode ? (
                    <input
                      type="number"
                      value={t.tech}
                      onChange={(e) => handleInputChange(i, "tech", e.target.value)}
                ...
                <td style={{ backgroundColor: "#D8F275" }}>
                  {editMode ? (
                    <input
                      type="number"
                      value={t.practical}
                      onChange={(e) => handleInputChange(i, "practical", e.target.value)}
                      className="form-control form-control-sm"
                    />
                  ) : (
                    t.practical
